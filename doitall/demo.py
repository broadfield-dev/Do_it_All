...
client_hf=[
    ...
    {'type':'text','loc':'hf','name':'deepseek-ai/DeepSeek-R1-Distill-Qwen-7B','rank':'op','max_tokens':40000,'schema':{'bos':'<s>','eos':'</s>'},'ppt':'None'},
    {'type':'text','loc':'hf','name':'deepseek-ai/DeepSeek-R1-Distill-Llama-8B','rank':'op','max_tokens':40000,'schema':{'bos':'<s>','eos':'</s>'},'ppt':'None'},
    {'type':'text','loc':'hf','name':'deepseek-ai/DeepSeek-R1-Distill-Qwen-14B','rank':'op','max_tokens':40000,'schema':{'bos':'<s>','eos':'</s>'},'ppt':'None'},
